...
function preload()
{
  ...
  enemy_img = loadImage("enemySpaceship1.png");
...
function setup() {
  ...
  enemy = createSprite(320,530,50,100);
  enemy.addImage(enemy_img);
  enemy.scale = 0.5;
  
  bomb = createSprite(320,200,50,100);
...
function stop() { vx = 0; vy = 0; fuel = 0; g = 0; }
function keyPressed()
{
